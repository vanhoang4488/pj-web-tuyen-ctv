...
INSERT INTO `blog_keys` VALUES (2827416839292,'2023-12-22 22:27:53','2023-12-22 22:28:47','LTYTHSKT',7);
...
CREATE TABLE `blogs_tags` (
  ...
  `tag_key` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKx3fpgfooloan6hqxab1bik23` (`blog_id`),
  KEY `FK7raqq3m1pmm1835n81twrjfb2` (`tag_key`),
  CONSTRAINT `FK7raqq3m1pmm1835n81twrjfb2` FOREIGN KEY (`tag_key`) REFERENCES `tags` (`tag_key`),
...
INSERT INTO `blogs_tags` VALUES (2024010101,'2023-12-22 00:00:00','2023-12-22 00:00:00',44444445,'LTYT'),(2024010102,'2023-12-22 00:00:00','2023-12-22 00:00:00',44444445,'STU'),(2825679796288,'2023-12-22 00:00:00','2023-12-22 00:00:00',2825679758368,'LTYT'),(2825679797336,'2023-12-22 00:00:00','2023-12-22 00:00:00',2825679758368,'STU'),(2825985909824,'2023-12-22 00:00:00','2023-12-22 00:00:00',2825985909884,'LTYT'),(2825985910204,'2023-12-22 00:00:00','2023-12-22 00:00:00',2825985909884,'STU'),(2826092900476,'2023-12-22 00:00:00','2023-12-22 00:00:00',2826092901240,'LTYT'),(2826092900796,'2023-12-22 00:00:00','2023-12-22 00:00:00',2826092901240,'STU'),(2826173473880,'2023-12-22 00:00:00','2023-12-22 00:00:00',2826173473813,'LTYT'),(2826173474114,'2023-12-22 00:00:00','2023-12-22 00:00:00',2826173473813,'STU'),(2826341872704,'2023-12-22 00:00:00','2023-12-22 00:00:00',2826341871624,'LTYT'),(2826341873528,'2023-12-22 00:00:00','2023-12-22 00:00:00',2826341871624,'STU'),(2827414709280,'2023-12-22 00:00:00','2023-12-22 00:00:00',2827414699072,'LTYT'),(2827414709312,'2023-12-22 00:00:00','2023-12-22 00:00:00',2827414699072,'STU'),(3670528669704,'2024-01-01 11:10:24','2024-01-01 11:10:24',3670528651586,'LTYT'),(3670528669784,'2024-01-01 11:10:24','2024-01-01 11:10:24',3670528651586,'HSKT');
...
CREATE TABLE `tags` (
  ...
  PRIMARY KEY (`tag_key`),
  KEY `FK2xe9bjpd83xeak9tst3srb4v9` (`class_id`),
  CONSTRAINT `FK2xe9bjpd83xeak9tst3srb4v9` FOREIGN KEY (`class_id`) REFERENCES `tag_classes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tags` VALUES ('CDMDC','2024-01-01 00:00:00','2024-01-01 00:00:00','Giúp đỡ nạn nhân bị chất độc màu gia cam',2023121902),('HCKK','2024-01-01 00:00:00','2024-01-01 00:00:00','Giúp đỡ các trường hợp có hoàn cảnh khó khăn',2023121902),('HSKT','2024-01-01 00:00:00','2024-01-01 00:00:00','Giúp đỡ học sinh bị khiếm thị',2023121902),('HSVC','2024-01-01 00:00:00','2024-01-01 00:00:00','Giúp đỡ học sinh vùng cao',2023121902),('LTYT','2024-01-01 00:00:00','2024-01-01 00:00:00','lan tỏa yêu thương',2023121901),('STU','2024-01-01 00:00:00','2024-01-01 00:00:00','dạy học',2023121901),('TTNV','2024-01-01 00:00:00','2024-01-01 00:00:00','tuyển tình nguyện viên',2023121901);
...
-- Dump completed on 2024-01-01 17:04:12
